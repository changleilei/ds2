...
def get_args():
    ...
    parser.add_argument("--data_path", type=str, required=True, default="", help="train dev test data path")
    parser.add_argument("--model_checkpoint", type=str, default="../chinese_t5_pegasus_base", help="Path, url or short name of the model")
    ...
    parser.add_argument("--num_beams", type=int, default=3, help="Number of beams for beam search during eval")
